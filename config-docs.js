...
const CONFIG = {
  ...
  // feed.xml is generated by generate-manifest.js from the same doc-walk
  // that builds manifest.json/sitemap.xml.
  RSS_ENABLED: true,
  RSS_URL:     '/feed.xml',
  // ── Search ───────────────────────────────────────────────────
  // [script] Fuzzy/typo-tolerant search via Fuse.js, lazy-loaded from
  //          jsDelivr only when the search box is first used — costs
  //          nothing on page load. Set false to fall back to the
  //          built-in substring matcher in doSearch().
