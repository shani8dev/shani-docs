---
title: ch* Commands (chmod, chown, chattr, ACLs)
section: System
updated: 2026-08-28
---
...
- [Filesystem Structure](../arch/filesystem.md) — subvolume layout and permissions
- [OpenSSH](../networking/openssh.md) — key permissions (`chmod 600`)
